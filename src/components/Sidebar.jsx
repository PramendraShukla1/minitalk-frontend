  ...
  const navList = (
    <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      ...
      <Typography
        ...
        className="flex items-center gap-x-2 p-1 font-medium"
      >
       <IoIosBookmarks width={16} height={17} className="w-[16px] h-[17px] text-gray-500"/>
        <Link to={`/language-marks/${id}`} className="flex items-center">
          My Marks
        </Link>
      </Typography>
      <Typography
      ...
      >
        ...
        <Link to={'/minitalk-english-test'} className="flex items-center">
          English Test
        </Link>
      </Typography>
      <Typography
      ...
      >
        ...
        <Link to={'/english-test-questions'} className="flex items-center">
      ...
      <MobileNav open={openNav}>
        <div className="container mx-auto">
         ...
         {!user? (<div className="flex items-center gap-x-1">
            ...
            <Button fullWidth variant="gradient" size="sm" className="" onClick={()=>navigate(`/profile/${id}`)}>{user.username}</Button>
          )}
        </div>
      </MobileNav>
    </Navbar>
