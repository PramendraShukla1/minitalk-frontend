...
const FrenchTest = () => {
    ...
    const userId = user._id
        const response = await axios.post('/submit-french-answers', {
          answers: formattedAnswers,
          user:userId
        });
        toast.success("Test submitted successfully please go to your profile page to check results", {
          position: "top-right",
          autoClose: 5000,
    ...
    useEffect(() => {
      const fetchQuestions = async () => {
        try {
          const response = await axios.get("/french-question-schema");
        ...
        {!user ? (
          <div className="flex justify-center mb-10 lg:p-0 p-5 mt-10 lg:mt-0">
            <h1 className="text-4xl font-serif font-semibold leading-snug ">
              Welcome to <span className="text-orange-700">French Language</span>{" "}
              Communication Game
            </h1>
          </div>
        ) : null}
            ...
            <div className="w-full p-5">
              <div className="flex justify-center">
                <h1 className="lg:text-4xl text-2xl font-serif font-semibold leading-snug underline">
                  Welcome to French Language Communication Game
                </h1>
              </div>
              {startTest ? (
