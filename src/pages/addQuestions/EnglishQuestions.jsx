...
const navigate = useNavigate()
  ...
  const submitQuestion = (e) => {
    e.preventDefault();
    try {
        axios.post('/english-question-schema',{
            question,
      ...
      <div className="w-full flex justify-center lg:flex-row flex-col lg:mb-28 mb-0 lg:mt-32 mt-32">
        ...
        <div className="lg:w-1/2 w-full">
          ...
          <div className="flex flex-wrap w-full  justify-center p-5 lg:mt-10 mt-5 ">
            <img src={uk} alt="" className="lg:w-1/2 shadow-xl" />
          </div>
        </div>
      </div>
      {/* Popper */}
        ...
        <div className="w-4/5 border border-gray-200 rounded-xl shadow-2xl p-5">
          ...
          <div className="mt-10 flex justify-center mb-10">
            <p className="w-3/4 text-center">
              ...
              questions for english test only.
            </p>
          </div>
              ...
              <form >
                <div>
                  ...
                  <input
                    type="text"
                    name="question1"
                    className="w-full p-3 border  outline-none border-gray-700 mt-3 rounded-xl placeholder:text-gray-700"
                ...
                <div className="w-full mt-5 flex gap-5">
                  ...
                  <div className="w-1/2 ">
                    <div>
                      <input
                        type="text"
                        className="p-3 border  outline-none border-gray-700 mt-3 rounded-xl w-full placeholder:text-gray-700"
                ...
                <div className="flex justify-center mt-10 gap-10">
                  <button className="p-5 border rounded-2xl bg-blue-300 font-semibold font-serif hover:bg-blue-500 hover:text-white w-1/2 text-xl" onClick={submitQuestion}>
                    Submit
                  </button>
                  <button className="p-5 border rounded-2xl bg-deep-purple-200 font-semibold font-serif hover:bg-red-700 hover:text-white w-1/2 text-xl" onClick={resetForm}>
                    Reset
                  </button>
                </div>
              </form>
